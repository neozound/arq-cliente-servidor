...
std::cout << "ui64:\t" << sizeof(uint64_t);
std::cout << "\t" << std::numeric_limits<uint64_t>::min();
std::cout << " .. " << std::numeric_limits<uint64_t>::max() << std::endl;

std::cout << "imax:\t" << sizeof(intmax_t);
std::cout << "\t" << std::numeric_limits<intmax_t>::min();
std::cout << " .. " << std::numeric_limits<intmax_t>::max() << std::endl;

std::cout << "uimax:\t" << sizeof(uintmax_t);
std::cout << "\t" << std::numeric_limits<uintmax_t>::min();
